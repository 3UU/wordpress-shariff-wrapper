...
if ( isset( $frontend ) && $frontend == '1' ) {
	...
	// paypal button id
	if ( array_key_exists( 'paypalmeid', $atts ) ) $paypalmeid = esc_html( $atts['paypalmeid'] );
	else $paypalmeid = '';
